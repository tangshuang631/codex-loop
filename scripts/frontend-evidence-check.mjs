...
const targets = [
  {
    ...
    requiredText: ["历史对话", "发送引导", "截图证据", "生产阶段", "生产成熟度", "剩余缺口", "闭环证据", "真实闭环", "下一轮验证", "验证目标", "启动预检", "复制命令", "复制文件", "脚本内容", "待合并", "已合并补充", "本地模型", "NPC", "conversation-detail-block", "file-path-chip"],
  },
  {
    name: "移动端",
    distLabel: "dist/mobile",
    distDir: path.join(root, "dist", "mobile"),
    requiredText: ["历史对话", "发送引导", "截图证据", "生产阶段", "生产成熟度", "剩余缺口", "闭环证据", "真实闭环", "下一轮验证", "验证目标", "启动预检", "复制命令", "复制文件", "脚本内容", "待合并", "已合并补充", "本地模型", "NPC", "conversation-detail-block", "markdown-code-block", "file-path-chip"],
  },
];
...
async function main() {
  ...
  const report = {
    ...
    results,
    nextAction: failed
      ? "先确认桌面端和移动端构建产物是否包含历史对话、发送引导、截图证据、生产阶段、生产成熟度、剩余缺口、闭环证据、真实闭环、下一轮验证、验证目标、启动预检、复制命令、复制文件、脚本内容、折叠详情、代码块、文件路径、待合并、已合并补充、本地模型和 NPC。"
      : "前端关键状态、历史对话、生产阶段、生产成熟度、剩余缺口、闭环证据、真实闭环、下一轮验证、验证目标、启动预检、复制命令、复制文件、脚本内容、折叠详情、代码块、文件路径、待合并、已合并补充、本地模型、NPC 和引导入口已进入构建产物。",
  };
