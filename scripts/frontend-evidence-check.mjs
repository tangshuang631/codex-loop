...
const targets = [
  {
    ...
    requiredText: ["历史对话", "发送引导", "截图证据", "生产阶段", "生产成熟度", "剩余缺口", "闭环证据", "真实闭环", "验证目标", "启动预检"],
  },
  {
    name: "移动端",
...
async function main() {
  ...
  const report = {
    ...
    results,
    nextAction: failed
      ? "先确认桌面端和移动端构建产物是否包含历史对话、发送引导、截图证据、生产阶段、生产成熟度、剩余缺口、闭环证据、真实闭环、验证目标和启动预检。"
      : "前端关键状态、历史对话、生产阶段、生产成熟度、剩余缺口、闭环证据、真实闭环、验证目标、启动预检和引导入口已进入构建产物。",
  };
